...
if(isset($_POST['submit']))
    ...
    $query3 = "INSERT INTO transactions (T_id, AccountID, TransactionCode, TransactioName, Debits, Balance) values(0,$accountid, 'TR', 'Transferred', $amount, $data)";
    $query4 = "INSERT INTO transactions (T_id, AccountID, TransactionCode, TransactionName, Credits, Balance) values(0,$accountno, 'TR', 'Transferred', $amount, $data2)";
